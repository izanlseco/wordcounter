...
public class WordCount {
    ...
    private static Stream<String> getAndSplitByWords(String[] args) throws IOException {
    ...
    private static Map<String, Integer> groupByConcurrences(Stream<String> unorderedStream) {
    ...
    private static void sortAndPrintMap(Map<String, Integer> concurrentMap){
